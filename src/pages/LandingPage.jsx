    ...
    <div style={{ background: '#f8fafc', color: '#0f172a', fontFamily: 'Manrope, sans-serif' }}>
      ...
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-16 flex flex-col lg:flex-row items-center gap-12">
        ...
        <div className="flex-1 text-center lg:text-left">
          ...
          <p className="text-xs text-gray-400 mt-4">No ads. No data selling. Ever.</p>
        </div>
        ...
        <div className="flex-1 w-full max-w-md lg:max-w-none">
          <div className="rounded-3xl overflow-hidden shadow-xl" style={{ background: '#ffffff', border: '1px solid #e2e8f0' }}>
            ...
            <div className="p-4 space-y-3" style={{ background: '#f8fafc' }}>
              {/* Net worth card */}
              <div className="rounded-2xl p-4 flex items-center justify-between" style={{ background: '#ffffff', border: '1px solid #e2e8f0' }}>
                <div>
                  <p className="text-xs text-gray-500 mb-1">Total Net Worth</p>
                  <p className="text-2xl font-extrabold text-gray-900">$47,832</p>
              ...
              <div className="grid grid-cols-2 gap-2">
                {[
                  ...
                  <div key={a.label} className="rounded-xl p-3" style={{ background: '#ffffff', border: '1px solid #e2e8f0' }}>
                    ...
                    <p className="text-sm font-bold text-gray-900">{a.val}</p>
                  </div>
                ))}
              </div>
              {/* Allocation checklist */}
              <div className="rounded-2xl p-4" style={{ background: '#ffffff', border: '1px solid #e2e8f0' }}>
                <p className="text-xs font-semibold text-gray-400 mb-3">Monthly Surplus Allocation</p>
                {[
      ...
      {/* Stats bar */}
      <div className="border-y py-8" style={{ borderColor: '#e2e8f0', background: '#ffffff' }}>
      ...
      <section className="max-w-5xl mx-auto px-6 py-20">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            <div key={f.title} className="rounded-2xl p-5" style={{ background: '#ffffff', border: '1px solid #e2e8f0' }}>
      ...
      <section className="py-16" style={{ background: '#f0fdf4', borderTop: '1px solid #bbf7d0', borderBottom: '1px solid #bbf7d0' }}>
        <div className="max-w-5xl mx-auto px-6 flex flex-col lg:flex-row items-center gap-10">
          ...
          {/* Chat mockup */}
          <div className="flex-1 w-full max-w-sm rounded-2xl overflow-hidden shadow-md" style={{ background: '#ffffff', border: '1px solid #e2e8f0' }}>
            ...
            <div className="p-4 space-y-3" style={{ background: '#f8fafc' }}>
              ...
              <div className="flex justify-start">
                <div className="rounded-2xl rounded-tl-sm px-3 py-2 text-sm max-w-[85%] text-gray-700" style={{ background: '#ffffff', border: '1px solid #e2e8f0' }}>
                  Based on your profile, a diversified mix of large-cap growth, dividend stocks, and broad index ETFs works well. Consider allocating 40% to total market ETFs like VTI...
                </div>
              </div>
              <div className="flex justify-end">
                <div className="rounded-2xl rounded-tr-sm px-3 py-2 text-sm max-w-[80%]" style={{ background: '#16a34a', color: 'white' }}>
      ...
      <section className="max-w-4xl mx-auto px-6 py-20">
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          {[
            ...
            <div key={s.title} className="flex gap-4 rounded-2xl p-5" style={{ background: '#ffffff', border: '1px solid #e2e8f0' }}>
