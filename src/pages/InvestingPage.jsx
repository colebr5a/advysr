...
function ResearchPanel({ profile, surplus }) {
    ...
    <div>
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="px-4 py-3 bg-primary-600 text-white rounded-xl font-medium text-sm hover:bg-primary-700 disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
        >
          Ask
        </button>
      </div>
      ...
      <div>
        ...
        <div className="flex flex-wrap gap-3 mb-4">
          {Object.entries(totalByType).map(([type, amt]) => (
            <div key={type} className={`px-4 py-2 rounded-xl ${TYPE_COLORS[type] || 'bg-gray-100 text-gray-300'}`}>
