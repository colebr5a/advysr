  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center px-4" style={{ background: '#f8fafc' }}>
      <div className="w-full max-w-md">
        ...
        {success ? (
          <div className="rounded-3xl shadow-sm p-8 text-center" style={{ background: '#ffffff', border: '1px solid #e2e8f0' }}>
          ...
          <div className="rounded-3xl shadow-sm p-8" style={{ background: '#ffffff', border: '1px solid #e2e8f0' }}>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-3 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-primary-500 transition-shadow"
